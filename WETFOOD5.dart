...
class WETFOOD5 extends StatefulWidget {
  const WETFOOD5({super.key});

  @override
  State<WETFOOD5> createState() => _WETFOOD5State();
}

class _WETFOOD5State extends State<WETFOOD5> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Royal Canin Maxi Puppy Wet Gravy Pouch Dog Food, 14(Pack of 10)',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text('- Quantity: 1.4 Kg', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
