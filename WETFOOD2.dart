...
class WETFOOD2 extends StatefulWidget {
  const WETFOOD2({super.key});

  @override
  State<WETFOOD2> createState() => _WETFOOD2State();
}

class _WETFOOD2State extends State<WETFOOD2> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Drools Adult Wet Dog Food, Real Chicken And Chicken Liver Chunks In Gravy, 24 Pouches (24 X 150G), 1 Count',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- A wholesome meal that supports the joint health of your pet', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Increased water content to maintain healthy digestive system', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- The combination of vitamins and other organic minerals helps to maintain healthy bones and stronger teeth', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Real chicken, liver and eggs keeps your pet active and agile all day long',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- This delicious food is enriched with natural ingredients which support healthy skin and coat of your dog', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
