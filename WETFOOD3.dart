...
class WETFOOD3 extends StatefulWidget {
  const WETFOOD3({super.key});

  @override
  State<WETFOOD3> createState() => _WETFOOD3State();
}

class _WETFOOD3State extends State<WETFOOD3> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('SMARTHEART Pouch Wet Dog Food Chicken & Liver Chunk in Gravy 80G (Pack of 12, 960 g)',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- Made From Real Meat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Complete and balanced nutrition for your dogs', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Strong Muscle  - Healthy Skin and Coat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Strong Bones and Teeth',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
