...
class WETFOOD8 extends StatefulWidget {
  const WETFOOD8({super.key});

  @override
  State<WETFOOD8> createState() => _WETFOOD8State();
}

class _WETFOOD8State extends State<WETFOOD8> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Drools Puppy Wet Dog Food, Real Chicken And Chicken Liver Chunks In Gravy,24 Pouches (24 X 150G)',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text('- Better digestibility and health', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(right: 140),
              child: Text('- Maintains joint health', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Healthy bones and stronger teeth',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
