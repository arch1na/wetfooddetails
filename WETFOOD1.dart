...
class WETFOOD1 extends StatefulWidget {
  const WETFOOD1({super.key});

  @override
  State<WETFOOD1> createState() => _WETFOOD1State();
}

class _WETFOOD1State extends State<WETFOOD1> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Pedigree Puppy Wet Dog Food, Chicken Chunks in Gravy, 70 g',
                style: TextStyle(
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Text('₹660', style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'Inter',
                      fontSize: 14,
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- See 5 signs of good health in just 6 weeks - a pedigree assurance!', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- dog food with tempting aroma and flavour effective to attract fussy eaters', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Ideal for Pugs, Beagle to Labrador, Golden Retriever & German shepherd', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Can be mixed with pedigree dry dog food or home cooked food, an ideal treat',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Moist chicken chunks gently cooked in healthy gravy, retaining vitamins', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- age_range_description: baby. item_form: Gravy. breed_recommendation: Pugs, Beagle, Labrador, Golden Retriever, German shepherd.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
